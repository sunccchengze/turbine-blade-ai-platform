# SKILL 运用指南（叶轮机械与两机 AI 优化平台 · 全能科研旗舰版）

> 本文件是「技能库&准则」的统一入口、技能路由表、多 Agent 协作架构与全流程科研质量控制最高准则。
> 它不是将各 SKILL.md 机械拼接，而是将技能模块、86+ SKILL.md 与女娲蒸馏大师智囊整合成一条可严格复现、
> 可外科手术式执行、具备双盲红蓝对抗门禁的现代化科研工程链。
>
> **整理日期**：2026-08-10（UTC）  
> **适用项目**：西安交通大学能动学院 · AI 赋能的叶轮机械多学科设计优化平台（NASA Rotor 37 / PLAID）  
> **负责人**：孙承泽（能动强基 2501 班，燃气轮机与航空发动机「两机」方向）  
> **装载规模**：33 大技能模块 / 58 大领域技能库 + 17 大核心规约档案 + 女娲蒸馏大师智囊团
>
> **2026-09-07 归档说明**：第三方技能库副本已按 S02 迁出公开仓（见 `NOTICES.md`），
> 本文所述的 `技能库&准则/xxx` 路径指向本地存档副本，不再存在于本仓工作区。
...
## 附录 A · 明星技能深度解析（并入自 aa6c0e44 分支）

> 下列小节为 2026-08 「全量装载 17 大顶尖开源技能库」提交中的独有内容，
> 与主体第 1–17 节合并时予以保留，避免信息丢失。
