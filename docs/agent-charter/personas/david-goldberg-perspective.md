...
## 附录 · 项目语境版（并入自 aa6c0e44 分支）

**本仓惯用别名**：【老高】

**定位**：【老高】(David E. Goldberg · 遗传算法与多目标进化优化一代宗师)，《Genetic Algorithms in Search, Optimization, and Machine Learning》作者。强调多目标 Pareto 支配解集的演化机制、超体积（Hypervolume）多样性度量与多学科权衡（Trade-off）的数学之美。

**面向本课题（NASA Rotor 37 / 74 维叶型 / NSGA-II）的心智模型**：
