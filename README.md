...
| 指标 | 最优值 | 相对训练集均值 |
|---|---|---|
| 等熵效率 η | **0.9211** | **+5.84%**（均值 0.8703） |
| 质量流量 ṁ | **21.64 kg/s** | **+10.93%**（均值 19.51） |
| 总压比 π | 2.1012 | 均值 1.9839 |

### 不确定性量化 MC Dropout UQ

推理时保持 Dropout 开启，采样 100 次得到预测分布，取 ±1.96σ 作为 95% 置信区间。
...
- [x] **Day 18** 线上部署总验收
- [x] **Day 19** README 中英双语重制 ← *当前*
- [ ] **Day 20–37** About/署名与 devlog、Pareto↔3D 联动、方法论页、移动端适配、压力测试与终版验收
