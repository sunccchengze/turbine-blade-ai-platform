...
- 16 级压气机的转子盘、叶片、静叶、平台、外壳加强环、迷宫密封和前六级 VSV 操作机构；
- 扩压器、去旋静叶、压气机出口腔、全环燃烧室、内外火焰筒、穹顶、30 路燃油喷嘴/总管、旋流器、两支点火器、内窥镜口、主燃/掺混/气膜冷却可视化孔阵；
- 两级空气冷却 HPT、六级自由动力涡轮、涡轮盘/围带/封严带、传动分离区、燃气发生器轴、自由动力轴、输出联轴器；
- 轴承滚子、轴承座、密封齿、滑油供回路、HPT 冷却空气示意管路、排气支板、尾锥和喷口；
- 分体机匣、法兰、径向紧固件、附件齿轮箱、燃油/滑油管线、温度探头、电缆、起吊耳、摄影棚材质/灯光/相机。
...
通过时，核验器将确认：**16** 个压气机转子级、**6** 个 VSV 静子级、**30** 个喷嘴体、**2** 个 HPT 转子级、**6** 个自由动力涡轮转子级，以及嵌入的范围声明。命令也会输出 Blender 版本、对象/网格总数和场景 metadata，便于审计。
