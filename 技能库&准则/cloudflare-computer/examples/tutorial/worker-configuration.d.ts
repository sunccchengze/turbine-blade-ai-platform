/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: 02899e46f79328d15e2621c770cbf283)
// Runtime types generated with workerd@1.20260616.1 2026-05-26 nodejs_compat
interface __BaseEnv_Env {
	CARDS: R2Bucket;
	AI: Ai;
	CARDS_BUCKET_NAME: "recipe-cards";
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	RecipeAgent: DurableObjectNamespace<import("./src/index").RecipeAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RecipeAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CARDS_BUCKET_NAME" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
