/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af4506cbc2be37b5b20a553dedf10010)
// Runtime types generated with workerd@1.20260722.1 2026-08-11 experimental,nodejs_compat
interface __BaseEnv_Env {
	LOADER: WorkerLoader;
	EGRESS_MODE: "none";
	EgressExample: DurableObjectNamespace<import("./src/index").EgressExample>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EgressExample";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EGRESS_MODE">> {}
}
