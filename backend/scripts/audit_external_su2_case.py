...
def parse_cfg(path: Path | None) -> dict:
    ...
    wanted = [
        ...
        "MARKER_HEATFLUX", "MARKER_FAR", "MARKER_ANALYZE", "MARKER_TURBOMACHINERY",
        "TURBOMACHINERY_KIND", "TURBO_PERF_KIND", "PERFORMANCE_AVERAGE_PROCESS_KIND",
        "MIXEDOUT_COEFF", "PERIODICITY", "ROTATION_RATE",
