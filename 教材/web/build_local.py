...
UNITS = [
    ("U01", "U01-机器与三个气动输出.md", "机器与三个气动输出"),
    ("U02", "U02-相对运动与欧拉做功.md", "相对运动与欧拉做功"),
    ("U03", "U03-激波附面层与Rotor37.md", "激波、附面层与 Rotor 37"),
    ("U04", "U04-RANS网格与残差收敛.md", "RANS、网格与残差收敛"),
    ("U05", "U05-从三万点到74维.md", "从三万点到 74 维"),
    ("U06", "U06-残差代理与损失.md", "残差代理、ONNX 与损失"),
    ("U07", "U07-R2划分与优化不可靠.md", "R²、划分与优化不可靠"),
    ("U08", "U08-MC-Dropout拆解.md", "MC Dropout 拆解"),
    ("U09", "U09-覆盖率与保形加宽.md", "覆盖率与保形加宽"),
    ("U10", "U10-Pareto与数不是叶子.md", "Pareto 与数不是叶子"),
    ("U11", "U11-红线与证据等级.md", "红线、证据等级与仓库"),
...
<body>
  <main class="main" style="max-width:980px">
    ...
    <p style="color:var(--color-text-muted);margin:0 0 24px">
      先读 <a href="how.html">怎么读这本书</a>。目录已重排：先机器和三个数，证据档在第 11 单元。
      空格看答案。数字只认 <code>evidence/</code>。公式用内置 KaTeX。
    </p>
