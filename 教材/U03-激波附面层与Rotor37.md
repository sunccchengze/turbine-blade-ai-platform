...
U01–U02 已会：π,η,ṁ，M_rel，叶尖先超音。本章回答：为什么 η 比另外两个尖。
...
**数据。** 叶尖公开 M_rel≈ 1.48（U02）。同一片子上叶尖 U=Ω r 更大，激波通常比轮毂强。
...
**操作。** 激波一立，波后压力陡升。逆压打在吸力面附面层上：层变厚，重则分离。分离泡里低能流体和主流掺混，熵跳一下。η 对「激波站在弦向何处」极敏感，接近间断；π 是进出口积分，没那么尖。

喉部先到声速。再降背压，∂ṁ/∂ P 接近 0。不是燃烧室进口。

**数据。** 代理最大流量点 ṁ≈ 21.74 kg/s 时 η≈ 0.873，相对 0.9173 掉了一截。叙事：靠近堵塞，槽道激波增强，吸力面分离。这两个数是代理点（后文 E2）。激波掀附面层是公开机理直觉，不是我们拍到的场。

**边界。** 把激波抹成等熵压缩会高估 η。优化页看最大流量附近，是为了看见权衡，不是只看 0.9173。
...
U05 会把每个样本收成 74 个数。那是全局统计，激波在弦向、叶高上的位置进不去。网络只能平滑地贴一个接近跳的 η。后文 Dropout 抖的是有效权重，抖不出「激波在 70% 叶高」。这是 U08–U09 里 η 覆盖率差的伏笔。现在先记住这条链。
...
**U03-S2-Q07 [中]【问】** 为何 η 对激波弦向位置比 π 尖？  
...
**U03-E-Q06 [中]【选】** 堵塞时 ∂ṁ/∂ P 大约：A. 很大 B. 近 0 C. 无穷 D. 负无穷  
...
**U03-E-Q15 [中]【问】** 同一片子上叶尖激波通常比轮毂强还是弱？联系 U=Ω r。  
