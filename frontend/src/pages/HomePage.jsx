      ...
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '92px 28px 76px', position: 'relative' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.05fr) minmax(300px,.95fr)', gap: 70, alignItems: 'end' }}>
          <motion.div initial="hidden" animate="visible" variants={fade}>
            ...
            <h1 style={{ color: 'var(--paper)', font: '600 clamp(46px,7vw,88px)/.93 var(--display)', letterSpacing: '-.07em', maxWidth: 760, marginTop: 19 }}>Run the design<br /><span style={{ color: 'var(--teal-bright)' }}>loop locally.</span></h1>
