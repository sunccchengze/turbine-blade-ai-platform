...
export default function ExplorePage() {
  ...
  return <main style={{ maxWidth: 1240, margin: '0 auto', padding: '58px 28px 90px' }}>
    <header style={{ display: 'flex', justifyContent: 'space-between', gap: 28, alignItems: 'end', flexWrap: 'wrap', marginBottom: 36 }}><div><SectionTitle>02 / 设计空间探索器 · Design Space Explorer</SectionTitle><h1 style={{ color: 'var(--paper)', font: '600 clamp(36px,5vw,62px)/1.14 var(--display)', letterSpacing: '-.04em', marginTop: 14 }}>在设计空间里<br /><span style={{ color: 'var(--teal-bright)' }}>看清性能如何变化</span><br /><span style={{ color: 'var(--faint)', font: '500 clamp(16px,2vw,24px)/1.3 var(--body)', letterSpacing: '-.02em' }}>See how performance moves through the design space</span></h1></div><p style={{ maxWidth: 350, color: 'var(--muted)', fontSize: 13, lineHeight: 1.8 }}>固定其余特征，只扫两个维度。响应面是代理模型的预测，不是真实 CFD 场。</p></header>
